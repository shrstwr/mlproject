    ...
    if request.method == 'GET':
        ...
        try:
            data = CustomData(
                ...
                reading_score=float(request.form.get('reading_score')),  # Fixed order
                writing_score=float(request.form.get('writing_score'))   # Fixed order
            )
            ...
            print("Predicted Score:", results[0])
